...
class UpdateUserModal extends Component {
    ...
    checkInput = () => {
        let arrInput = ['email', 'password', 'phoneNumber', 'address', 'firstName', 'lastName']
                    ...
                    <ModalBody>
                        ...
                        <div className='input-group'>
                            <div className='input-container'>
                                ...
                                <input type='text' placeholder='First name...' id='firstName' value={this.state.firstName}
                                    onChange={(e) => this.handleInputChange(e)} />
                            </div>
                            <div className='input-container'>
                                <label for='lastName'>Last name</label>
                                <input type='text' placeholder='Last name...' id='lastName' value={this.state.lastName}
                                    onChange={(e) => this.handleInputChange(e)} />
                            </div>
                        </div>
                        <div className='input-group'>
                            <div className='input-container'>
                                ...
                                <input type='text' placeholder='Address...' id='address' value={this.state.address}
                                    onChange={(e) => this.handleInputChange(e)} />
                            </div>
                            <div className='input-container'>
                                <label for='phoneNumber'>Phone number</label>
                                <input type='tel' placeholder='Phone number...' id='phoneNumber' value={this.state.phoneNumber}
                                    onChange={(e) => this.handleInputChange(e)} />
                            </div>
                        </div>
